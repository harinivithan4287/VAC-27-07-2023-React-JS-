...
import MyPhoto from '../assets/hari.jpeg'
      ...
      <div className='body'>
          <div className='body-left' >
              <div className='Hi-div' >
                <h1 className='hi'>👋 Hi, I’m HARINIVITHAN K</h1>
              </div>
              <div className='about'>
              ...
              <div className='me' >
                ...
                <spam className="expert-spam"> Multiplica Talent Chile</spam></p>
               
                </div>
                <div className='contact'>
                    <p className='contact-p' id='c1'>India</p>
                    <p className='contact-p' id='c2'>harinivithan@gmail.com</p>
                </div>
          ...
          <div className='body-right' >
            ...
            <div className='name' >
                <p className='name-para' >HARINIVITHAN</p>
            </div>
